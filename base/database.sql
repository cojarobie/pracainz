...
CREATE TABLE Scheduled (
	...
	CONSTRAINT PK_Leagues PRIMARY KEY (ID),
	CONSTRAINT FK_Scheduled_FTL FOREIGN KEY (ID_First_Team_League) REFERENCES Teams_Leagues(ID) ON UPDATE CASCADE ON DELETE CASCADE,
	CONSTRAINT FK_Scheduled_STL FOREIGN KEY (ID_Second_Team_League) REFERENCES Teams_Leagues(ID) ON UPDATE CASCADE ON DELETE CASCADE
);
